...
class _DriverDashboardState extends State<DriverDashboard> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkProfileCompletion() async {
    try {
      ...
      setState(() {
        _isProfileComplete = profileResponse.statusCode == 200;
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                'Complete your driver profile to access all features and get better job matches.',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildFeatureRow(Icons.work, 'Access to all job listings'),
                    _buildFeatureRow(Icons.favorite, 'Save favorite jobs'),
                    _buildFeatureRow(Icons.verified, 'Get verified driver badge'),
                    _buildFeatureRow(Icons.trending_up, 'Better job recommendations'),
                  ],
                ),
              ),
            ],
                            ...
                            const Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Unlock all features by completing your driver profile',
